...
technique NonRotatingParticles
{
    pass P0
    {
        ...
        PixelShader = compile ps_4_0_level_9_1 NonRotatingPixelShader();
	#else
		VertexShader = compile vs_3_0 VShader();
        PixelShader = compile ps_3_0 NonRotatingPixelShader();
	#endif
...
technique RotatingParticles
{
	...
	#ifdef SM4
        VertexShader = compile vs_4_0_level_9_1 VShader();
        PixelShader = compile ps_4_0_level_9_1 RotatingPixelShader();
	#else
		VertexShader = compile vs_3_0 VShader();
